	...
	<div id="shortcut-2013">
		<div class="w">
			<ul class="fl lh">
				...
				<a href="#" rel="nofollow">收藏京东</a></li>
			</ul>
			<ul class="fr lh">
				<li class="fore1" id="loginbar">您好，欢迎来到京东！<span>
					<a href="#">[登录]</a> <a href="#" class="link-regist">[免费注册]</a></span></li>
				<li class="fore2 ld"><s></s> 
					<a href="#" rel="nofollow">我的订单</a>
				</li>
				<li class="fore2-1 ld" id="jd-vip"><i></i> <i></i> <s></s> 
					<a target="_blank" rel="nofollow" href="http://vip.jd.com/">会员俱乐部</a>
				</li>
				<li class="fore2-2 ld" id="jd-dakehu"><i></i><s></s> 
					<a href="http://b.jd.com/" target="_blank" rel="nofollow">企业频道</a>
				</li>
				<li class="fore3 ld menu" id="app-jd" data-widget="dropdown"
					clstag="homepage|keycount|home2013|01d"><s></s> <i></i> 
					<span class="outline"></span> 
					<span class="blank"></span> 
					<a href="http://app.jd.com/" target="_blank">手机京东</a> <b></b>
				</li>
				<li class="fore4 ld menu" id="biz-service" data-widget="dropdown"><s></s> 
					<span class="outline"></span> 
					<span class="blank"></span>
					客户服务 <b></b>
				</li>
					...
					<div data-id="100002" class="prop-attrs">
						<div class="attr">
							...
							<div class="a-values">
								<div class="v-fold">
									<ul class="f-list">
										<c:forEach items="${result.scopeList }" var="li">
											<li><a href="javascript:filter('price','${li }')"><span style="color: ${price eq li ? 'red' : ''}">${li}</span></a></li>
										</c:forEach>
